...
const ClickHandler = ({ setPosition, fetchAddress }) => {
    useMapEvents({
        click(e) {
            ...
            console.log("Position set to:", newPos); // Log position
        }
    });
    return null;
};
...
const LocationSelector = () => {
    ...
    const fetchAddress = async (lat, lon) => {
        try {
            ...
            console.log("Address fetched:", data.address); // Log address data
        } catch (err) {
    ...
    const handleSearchLocation = async () => {
        ...
        try {
            ...
            if (data && data.length > 0) {
                ...
                console.log("Location found:", newPos); // Log position
    ...
    useEffect(() => {
        navigator.geolocation.getCurrentPosition(
            (pos) => {
                ...
                console.log("Geolocation fetched:", newPos); // Log position
            },
            () => {
            ...
            <div className="px-8 py-6 relative lg:px-20">
                <div className="flex flex-col lg:flex-row gap-10 lg:gap-15 xl:gap-20 ">
                    ...
                    <div className="flex-1 flex flex-col justify-between h-[650px]">
                        ...
                        <button
                            onClick={() => {
                                console.log("Location saved:", position); // Log the current position
                                console.log("Address saved:", address); // Log the current address
